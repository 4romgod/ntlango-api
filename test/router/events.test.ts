...
describe('Events Routes', () => {
    ...
    it('should define the /events/:eventId/rsvp (post) route', () => {
        ...
        const route = eventsRouter.stack.find((layer: any) => layer.route?.path === '/events/:eventId/rsvp' && layer.route.methods.post === true);
    ...
    it('should define the /events/:eventId/cancelrsvp (post) route', () => {
        ...
        const route = eventsRouter.stack.find(
            (layer: any) => layer.route?.path === '/events/:eventId/cancelrsvp' && layer.route.methods.post === true,
        );
